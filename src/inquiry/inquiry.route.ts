...
import { UpdateInquiryDto, CreateOrUpdateInquiryReplyDto } from './dto/inquiry.dto';
import { authorizeBuyer, authorizeSeller } from 'src/middleware/authorization';
import InquiryController from './inquiry.controller'; // 클래스 import
import InquiryService from './inquiry.service'; // 서비스 클래스 import
import InquiryRepository from './inquiry.repository';
import { PrismaClient } from '@prisma/client/extension';
// import { NotificationRepository } from 'src/notification/notification.repository';
import { NotificationService } from 'src/notification/notification.service';

const InquiryRouter = (prisma: PrismaClient, notificationService: NotificationService): Router => {
  const router = Router();
  ...
  router.get(
    '/:inquiryId',
    passport.authenticate('jwt', { session: false }),
    inquiryController.getDetailInquiry
  );
  ...
  router.post(
    ...
    passport.authenticate('jwt', { session: false }),
    authorizeSeller,
    inquiryController.postInquiryReply
  );
  ...
  router.get(
    '/:replyId/replies',
    passport.authenticate('jwt', { session: false }),
    inquiryController.getDetailReply
  );
